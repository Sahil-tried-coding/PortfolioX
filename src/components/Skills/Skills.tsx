...
<div className=" flex items-center gap-[12px] pt-[2rem] pl-[8rem]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-7  items-center justify-center mx-[20rem]">
        {skills.map((skill, index) => (
          <SpotlightCard className="custom-spotlight-card w-[200px]" spotlightColor={skill.color}>
